...
import { allAltars, locatedCounties } from '@/lib/altars'
    ...
    <main>
      ...
      <div className="shell pb-24 pt-16">
        ...
        <Section>
          ...
          {/* The altars used to be listed here in full, and a reader who
              came to this page for one county had to read six sections
              about the mission before reaching twenty-six cards with
              nothing to search and nothing to point at. They have a page
              of their own now, with the country drawn on it. This says
              how much ground is covered and hands them over. */}
          <Link
            href="/altars"
            className="focus-ring group block rounded-panel border border-rule bg-card p-7 transition-colors hover:border-gold/60 sm:p-9"
          >
            <dl className="mb-8 grid gap-6 sm:grid-cols-3">
              {[
                { figure: String(counties.length), label: 'Counties in Kenya' },
                ...
                <div key={stat.label}>
                  ...
                  <dd>
                    <span className="tabular block font-display text-[2.125rem] leading-none text-navy">
                      {stat.figure}
                    </span>
                    <span
                      aria-hidden
                      className="mt-2.5 block font-mono text-[0.625rem] uppercase tracking-[0.08em] text-ink-subtle"
                    >
                      {stat.label}
                    </span>
                  </dd>
            ...
            <p className="mb-6 max-w-measure text-[0.9375rem] leading-[1.75] text-ink-700">
              Every altar is published with its place on the map, the road it stands on, and the
              number of the clergy leading it where one has been given. Counties we cannot yet
              direct anyone to are named there too, rather than quietly left out.
            </p>

            <span className="kicker flex items-center gap-2 text-gold-ink">
              Find the altar nearest you
              <ArrowRight
                aria-hidden
                className="h-3.5 w-3.5 transition-transform group-hover:translate-x-1"
              />
