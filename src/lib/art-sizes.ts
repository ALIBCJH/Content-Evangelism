...
export const artSizes: Record<string, readonly [number, number]> = {
  ...
  '/images/articles/christ-is-coming-desktop.webp': [1312, 816],
  ...
  '/images/articles/unforgivable-sin-desktop.webp': [1312, 816],
