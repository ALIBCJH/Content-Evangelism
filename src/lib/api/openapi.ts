      ...
      schemas: {
        ...
        TeachingRecording: {
          ...
          properties: {
            ...
            dated: { type: 'string', enum: ['preached', 'published'] },
            year: { type: 'string' },
            durationSeconds: { type: 'integer' },
            duration: { type: 'string', description: 'Runtime, ISO 8601.' },
            published: {
              type: 'string',
              description: 'When the ministry published the recording on its channel.',
            },
            place: { type: 'string' },
            series: { type: 'string' },
